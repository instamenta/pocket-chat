...
export default function Chat({
  ...
  return (
    <>
      <section className="hidden lg:block pb-3 ">
        <Navbar />
      </section>
      <Sidebar />

      <div className="bg-slate-100 md:mx-auto md:w-[680px]">
        ...
        <form
          className="top-shadow fixed bottom-0 z-40 flex w-full flex-row px-5 pb-3 pt-1 align-middle md:mx-auto md:w-[665px]"
