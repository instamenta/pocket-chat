    ...
    <>
      <div className="flex items-center justify-between border-b px-3 py-2">
        <div className="flex flex-wrap items-center divide-gray-200 sm:divide-x sm:rtl:divide-x-reverse">
          <div className="flex items-center space-x-1 sm:pe-4 rtl:space-x-reverse">
            <button
              type="button"
              className="cursor-pointer rounded p-2 text-gray-500 transition-all hover:bg-gray-100 hover:text-blue-600"
            >
              <svg
                className="h-4 w-4"
                aria-hidden="true"
        ...
        <button
          type="button"
          data-tooltip-ttransition-all=""
          className="blue:600-gray-100 cursor-pointer rounded p-2 text-gray-500 hover:text-gray-900 sm:ms-auto"
        >
          <svg
            className="h-4 w-4"
            aria-hidden="true"
      ...
      <div className="rounded-b-lg bg-white px-4 py-2">
        <textarea
          ...
          className="block w-full border-0 bg-white px-0 text-sm text-gray-800 outline-none focus:ring-0"
