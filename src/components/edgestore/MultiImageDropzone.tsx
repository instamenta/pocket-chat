...
const variants = {
  base: 'relative rounded-md aspect-square flex justify-center items-center flex-col cursor-pointer min-h-[150px] min-w-[200px] border border-dashed border-gray-400 transition-colors duration-200 ease-in-out',
  image:
    'border-0 p-0 w-full h-full relative shadow-md bg-slate-200 rounded-md',
  active: 'border-2',
  disabled:
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            {value?.map(({ file, progress }, index) => (
              <div
                ...
                className={
                  variants.image +
                  ' rounded-xs mr-2 aspect-square h-full outline outline-1 outline-gray-300'
                }
              >
                <img
                  className="aspect-square h-full rounded-md object-center"
                  src={imageUrls[index]}
                ...
                {imageUrls[index] && !disabled && progress === 'PENDING' && (
                  ...
                  >
                    <div className="flex h-5 w-5 cursor-pointer items-center justify-center rounded-md border border-solid border-gray-500 bg-white transition-all duration-300 hover:h-6 hover:w-6 ">
