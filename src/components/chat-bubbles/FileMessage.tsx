        ...
        <div className="leading-1.5 flex w-full max-w-[326px] flex-col rounded-e-xl rounded-es-xl border-gray-200 bg-white px-4 pb-2 shadow-xl">
          <div className="my-2.5 flex items-start rounded-xl bg-gray-50 p-2">
            ...
            <div className="inline-flex items-center self-center">
              <button
                className="focus:ring-gray-50f inline-flex items-center self-center rounded-lg bg-gray-50 p-2 text-center text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4"
                type="button"
              >
                <svg
